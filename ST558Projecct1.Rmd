...
Like the allPoke() function above, this generation function queries the Generation API to get all of the information available. This is not a function that is user queryable, and is part of the generation function. 
